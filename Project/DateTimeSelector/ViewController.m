...
- (void)viewDidLoad
{
 ...
 //   _dateFormatter.timeStyle = NSDateFormatterShortStyle;
    ...
    /*
    _selectorView = [[ImpDateTimeSelectorView alloc] initWithFrame:CGRectMake(0, self.view.bounds.size.height - 100, self.view.bounds.size.width, 100)];
    _selectorView.dateTimeTypes = ImpDateTimeTypeDay|ImpDateTimeTypeHour|ImpDateTimeTypeYear|ImpDateTimeTypeMonth|ImpDateTimeTypeDay;
    float white = .80;
    for(ImpDateTimeSelectorPad *pad in _selectorView.selectorPads)
    {
        pad.backgroundColor = [UIColor colorWithWhite:white alpha:1.0];
        pad.showDefaultValueLabel = YES;
        white -= .1;
    }
